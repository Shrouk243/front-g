...
function getStatus(value: number) {
  if (value < 70) return { color: "#DC2626", bg: "#FEE2E2", label: "Low" };
  if (value <= 99) return { color: "#16A34A", bg: "#DCFCE7", label: "Normal" };
  if (value <= 140) return { color: "#B45309", bg: "#FEF3C7", label: "Elevated" };
              ...
              <div style={{ display: "flex", gap: 16, alignItems: "center", marginBottom: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ display: "inline-flex", alignItems: "center", gap: 6, background: getStatus(getVitalNumericValue(latest)).bg, borderRadius: 10, padding: "4px 12px" }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 700, color: getStatus(getVitalNumericValue(latest)).color }}>{getStatus(getVitalNumericValue(latest)).label}</span>
                  </div>
                </div>
              </div>
